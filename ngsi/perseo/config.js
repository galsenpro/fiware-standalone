 ...
 */
config.orionDb = {
    url : 'mongodb://mongo:27017/orion-testservice',
    collection : 'entities',
    prefix : 'orion', // orion container name
    batchSize: 500
};
 ...
 */
config.perseoCore = {
    rulesURL : 'http://perseo-core:8080/perseo-core/rules',
    noticesURL : 'http://perseo-core:8080/perseo-core/events',
    interval: 60e3 // *5
};
/**
...
config.sms = {
    ...
    API_KEY : '',
    API_SECRET: '',
    from: 'tel:22012;phone-context=+33'
};
 ...
 * @type {{}}
 */
config.DEFAULT_SUBSERVICE= '/testalain';
config.DEFAULT_SERVICE= 'testservice';
